...
--
--   1. KAPSAM  — adlandirilmis izin ("dugum_duzenle"). Ne yapabilecegini soyler.
--   2. DUGUM IZNI — hangi dalda yapabilecegini soyler. Bir dugume izin verilirse
--      ALT AGACININ tamami kapsanir; ayri ayri satir yazilmaz.
--
-- Ikisi BIRLIKTE gerekiyor: "dugum_duzenle" kapsami olmayan kisi hicbir dalda
...
-- --- kullanicinin kapsamlari ---------------------------------------------
-- Kapsam adlari KODDA tanimli (shared/kapsam.py). Veritabani serbest metin
...
-- --- kullanicinin duzenleyebilecegi dugumler ------------------------------
